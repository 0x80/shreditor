...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 408.0, 72.0, 154.0, 47.0 ],
					"presentation" : 0,
					"presentation_rect" : [ 0.0, 0.0, 0.0, 0.0 ],
					"text" : "voor xt, worden deze parameters uitgestuurd als je aan de knoppen zit",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 352.0, 432.0, 62.0, 20.0 ],
					"presentation" : 0,
					"presentation_rect" : [ 0.0, 0.0, 0.0, 0.0 ],
					"text" : "zl change",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 352.0, 464.0, 82.0, 20.0 ],
					"presentation" : 0,
					"presentation_rect" : [ 0.0, 0.0, 0.0, 0.0 ],
					"text" : "speedlim 100",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
				...
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_type" : 2,
							"parameter_mmax" : 16.0,
							"parameter_enum" : [ "off", "thru", "seq", "ctrl", "full", "1>l", "2>1", "3>2", "4>3", "5>4", "6>5", "7>6", "8>7" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 128.0, 131.0, 37.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 128.0, 168.0, 46.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"panelcolor" : [ 0.955487, 0.975006, 1.0, 1.0 ],
					"parameter_enable" : 1,
					"patching_rect" : [ 584.0, 312.0, 44.0, 49.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 278.0, 432.0, 69.0, 20.0 ],
					"presentation" : 0,
					"presentation_rect" : [ 0.0, 0.0, 0.0, 0.0 ],
					"text" : "temp block",
					"textcolor" : [ 0.094118, 0.117647, 0.137255, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"bgcolor2" : [ 0.271739, 0.271739, 0.271739, 1.0 ],
					"depth" : 0,
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 400.0, 256.0, 100.0, 19.0 ],
					"pattrmode" : 0,
					"prefix" : "",
					"prefix_mode" : 0,
					"presentation" : 1,
					"presentation_rect" : [ 112.0, 120.0, 80.0, 19.0 ],
					"rounded" : 8,
					"showdotfiles" : 0,
					"textcolor" : [ 0.863854, 0.863854, 0.863854, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"panelcolor" : [ 0.955487, 0.975006, 1.0, 1.0 ],
					"parameter_enable" : 1,
					"patching_rect" : [ 528.0, 312.0, 44.0, 49.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"panelcolor" : [ 0.955487, 0.975006, 1.0, 1.0 ],
					"parameter_enable" : 1,
					"patching_rect" : [ 472.0, 312.0, 52.0, 49.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"panelcolor" : [ 0.955487, 0.975006, 1.0, 1.0 ],
					"parameter_enable" : 1,
					"patching_rect" : [ 416.0, 312.0, 44.0, 49.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"panelcolor" : [ 0.955487, 0.975006, 1.0, 1.0 ],
					"parameter_enable" : 1,
					"patching_rect" : [ 352.0, 312.0, 44.0, 49.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 760.0, 344.0, 56.0, 19.0 ],
					"pattrmode" : 0,
					"prefix" : "",
					"prefix_mode" : 0,
					"presentation" : 1,
					"presentation_rect" : [ 152.0, 80.0, 40.0, 19.0 ],
					"rounded" : 8,
					"showdotfiles" : 0,
					"textcolor" : [ 0.863854, 0.863854, 0.863854, 1.0 ],
					"textcolor2" : [ 0.863854, 0.863854, 0.863854, 1.0 ],
