...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 179.0, 94.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 184.0, 96.0, 75.0, 20.0 ],
					"text" : "Channel"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 32.0, 96.0, 48.0, 20.0 ],
					"text" : "refresh"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 8.0, 96.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 136.0, 328.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 184.0, 64.0, 75.0, 20.0 ],
					"text" : "Merge Input"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 184.0, 32.0, 47.0, 20.0 ],
					"text" : "Output"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 184.0, 0.0, 37.0, 20.0 ],
					"text" : "Input"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 377.0, 113.0, 133.0, 18.0 ],
					"text" : "symbol \"Cirklon Port 1\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 592.0, 152.0, 32.5, 18.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 592.0, 184.0, 32.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 144.0, 96.0, 32.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 416.0, 216.0, 98.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 416.0, 184.0, 168.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 8.0, 64.0, 168.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 416.0, 152.0, 55.0, 21.0 ],
					"text" : "midiinfo"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 64.0, 216.0, 74.0, 20.0 ],
					"text" : "s midiInPort"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 240.0, 216.0, 83.0, 20.0 ],
					"text" : "s midiOutPort"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 8.0, 0.0, 168.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 8.0, 32.0, 168.0, 21.0 ]
				}
